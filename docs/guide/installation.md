...
{
  "agents": {
    "plan-consultant": { "model": "amazon-bedrock/us.anthropic.claude-fable-5-1" },
...
| --------------------- | ---------------------------------------- |
| **plan-consultant**   | `github-copilot/claude-fable-5-1`        |
...
| Agent / category      | Model                                                |
| --------------------- | ---------------------------------------------------- |
| **plan-consultant**   | `opencode/claude-fable-5-1`                          |
...
| **explore**         | Fast codebase grep                         | openai\|openai-codex/gpt-5.6-luna-fast (low) → deepseek/deepseek-v4-flash (max) → opencode-go\|bailian-coding-plan/qwen3.7-plus → … → anthropic\|github-copilot/claude-haiku-4-5 → openai\|openai-codex/gpt-5.4-nano (full chain in source) |
...
{
  "agents": {
    "plan-consultant": { "model": "anthropic/claude-fable-5-1" },
